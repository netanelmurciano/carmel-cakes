                               ...
                               <div class="col-12 col-md-8 d-flex mx-auto  h-100">
                                   <div class="row w-100">
                                       <div class="col-12 align-self-center justify-content-center">
                                           <div class="w-100">
                                               <div class="text-slider-title text-center"><?php the_sub_field( 'title' ); ?></div>
                                               <div class="h6 text-center"><?php the_sub_field( 'sub_title' ); ?></div>
                                               <p class="p-relative zi-1"><?php the_sub_field( 'text' ); ?></p>
                                           </div>
                                       </div>
                                   </div>
                               </div>
